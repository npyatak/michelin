...
<div class="page_wrapper ">
    ...
    <?php if(Yii::$app->user->isGuest):?>
        <div class="start-question text">
            <div class="like-p">
                <p>Поддержи любимую команду даже на выездных матчах! <b><a href="<?=Url::toRoute(['site/video']);?>" style="text-transform: uppercase;">Смотри</a></b> уникальные видео о самых красивых местах России, отвечай на вопросы Викторины и получи шанс выиграть стильные призы от Michelin, а также годовой абонемент на матчи своего любимого клуба!</p>
